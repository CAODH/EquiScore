...
def parse_train_args():
    ...
    parser.add_argument('--save_model', type=str, default = './workdir/official_weight/save_best_f1_model_screen.pt',help='model for test or restart training')
    parser.add_argument('--lmdb_cache', type=str, default='/home/caoduanhua/score_function/data/lmdbs/pose_challenge_cross_10', help='Folder containing trainging data in lmdb format')
    parser.add_argument('--data_path', type=str, default='/home/caoduanhua/score_function/GNN/EquiScore/data/training_data/PDBscreen', help='Folder containing trainging data')
    ...
    # Dataset
    parser.add_argument('--train_keys', type=str, default='/home/caoduanhua/score_function/GNN/config_keys_results/new_data_train_keys/train_keys/pdb_screen_neg_5_bind_keys_pose_enhanced_challenge_10/train_keys.pkl', help='Path of file defining the split')
    parser.add_argument('--val_keys', type=str, default='/home/caoduanhua/score_function/GNN/config_keys_results/new_data_train_keys/train_keys/pdb_screen_neg_5_bind_keys_pose_enhanced_challenge_10/val_keys.pkl', help='Path of file defining the split')
    parser.add_argument('--test_keys', type=str, default='/home/caoduanhua/score_function/GNN/config_keys_results/new_data_train_keys/train_keys/pdb_screen_neg_5_bind_keys_pose_enhanced_challenge_10/test_keys.pkl', help='Path of file defining the split')
    ...
    parser.add_argument('--ngpu', type=int, default=7, help='Number of gpu for training')
    ...
    parser.add_argument('--patience', type=int, default=150, help='Patience of early stopping')
    ...
    parser.add_argument('--layer_norm', action='store_true', default=True, help='dynamic sampler or not')
    parser.add_argument('--graph_norm', action='store_true', default=True, help='dynamic sampler or not')
    parser.add_argument('--residual', action='store_true', default=True, help='dynamic sampler or not')
