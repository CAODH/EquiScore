...
#/home/jiangjiaxin/../../../
parser.add_argument("--save_dir", help="save directory of model parameter", type=str, default ='/home/caoduanhua/score_function/GNN/train_result/min_rmsd')
...
#'/home/caoduanhua/score_function/data/pocket_dude/pocket_data'
...
save_path = args.save_dir+ '/dude/independent_test/' + args.fundation_model + '/'+ args.layer_type +'/' + time.strftime('%Y-%m-%d-%H-%M-%S')
...
if args.ngpu>0:
    ...
    print(cmd)
best_name = '/home/caoduanhua/score_function/GNN/train_result/min_rmsd/graphnorm/graphformer/GAT_gate/2022-01-17-06-58-25/save_best_model.pt'
