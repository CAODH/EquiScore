...
#/home/jiangjiaxin/../../../
parser.add_argument("--save_dir", help="save directory of model parameter", type=str, default ='/home/caoduanhua/scorefunction/GNN/train_result/graphnorm/dude/')
parser.add_argument("--initial_mu", help="initial value of mu", type=float, default = 2.5)
parser.add_argument("--initial_dev", help="initial value of dev", type=float, default = 4.0)
...
parser.add_argument("--train_keys", help="train keys", type=str, default='/home/caoduanhua/score_function/GNN/GNN_graphformer/keys/train_keys.pkl')
parser.add_argument("--test_keys", help="test keys", type=str, default='/home/caoduanhua/score_function/GNN/GNN_graphformer/keys/test_keys.pkl')
#add by caooduanhua
...
parser.add_argument("--test_path", help="test keys", type=str, default='/home/caoduanhua/scorefunction/data/independent/dekois_pocket')
# '/home/caoduanhua/scorefunction/data/dekois_pocket'
# /home/caoduanhua/scorefunction/data/independent/dude_pocket

#'/home/caoduanhua/score_function/data/pocket_pcba_full/pocket'
...
# args.adap_per_epoch_step
parser.add_argument("--adap_per_epoch_step", help="select for per step in epoch fixed or adaptive to mini size in all domain ", action = 'store_false')       
# select train mode
parser.add_argument("--train_mode", help="select to meta-learning or anather mode ", type=str, default='meta_naive')
...
# args.domain_num
parser.add_argument("--domain_sum", help="multi_pros as a domain", type=float, default = 10)
...
parser.add_argument("--from_mse_pretrain", help="from_mse_pretrain  ", action = 'store_true')
# save_logits
parser.add_argument("--save_model", help="hot start", type=str, default='/home/caoduanhua/score_function/GNN/train_result/MSE/paper/GAT_gate/2021-11-25-12-45-42/save_best_model.pt')
# parser.add_argument("--hot_start", help="hot start", action = 'store_true')
# parser.add_argument("--save_model", help="hot start", type=str, default='/home/caoduanhua/score_function/GNN/train_result/GNN_crose_decoy/graphformer/GAT_gate/2021-09-27-20-18-06/save_best_model.pt')
...
parser.add_argument("--norm_type",help = 'select norm type in gnnyou can select  ln or gn ',type = str,default = 'gn')
#pred_mode
