...
valid_keys = glob.glob('/home/caoduanhua/score_function/data/general_refineset/pdbbind_all_native/redock_sample/*')
valid_keys +=glob.glob('/home/caoduanhua/score_function/data/general_refineset/pdbbind_all_native/pdbbind_redocked_fail/*')
