...
valid_keys += get_part_data(cross_decoys_dir,cross_decoys,fast_num=11,active_names = active_pros)
...
valid_keys_screen += get_part_data_screen(cross_decoys_dir_screen,cross_decoys_screen,fast_num=14,active_names = active_pros_screen)
