...
##################################### shape decoys############################################
valid_keys += glob.glob('/home/caoduanhua/score_function/data/general_refineset/pdbbind-shape_decoy_align_pocket-5/*')
print(' pdbbind len of shape decoys: ',len(valid_keys))
#----------------------------------------------------------------
# 先获取了pdbbind 的数据
import pickle
...
# add shape match decoys
# valid_keys_screen += glob.glob('/home/caoduanhua/score_function/data/pdb_screen/screen_shape_pocket/*')
...
print(' pdb screen len of cross decoys  + active: ',len(valid_keys_screen))
################################################ get shape match screen ###########################################

valid_keys_screen +=glob.glob('/home/caoduanhua/score_function/data/pdb_screen/screen_shape_pocket/*')
print(' pdb screen len of decoys: ',len(valid_keys_screen))
