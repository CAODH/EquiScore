...
def run(local_rank,args,*more_args,**kwargs):
    ...
    getEF(model,args,args.test_path,save_path,args.device,args.debug,args.batch_size,args.A2_limit,loss_fn,args.EF_rates,flag = '_RTMSCORE_bedroc_goldchemplp' + args.test_name,prot_split_flag = '_')
