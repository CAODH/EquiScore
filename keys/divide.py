...
import glob
random.seed(0)
data_dir = '/home/caoduanhua/score_function/data/pocket_data/'
...
train_keys = [ data_dir + k for k in valid_keys if k.split('_')[0] in train_dude_gene]    
test_keys = [data_dir + k for k in valid_keys if k.split('_')[0] in test_dude_gene]    
