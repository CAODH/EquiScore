...
# print(glob.glob(os.path.('../../trainging_data/*')))
import sys

'''
in this scipt , i recommend you to use absolute path to run this script

you should download the PDBscreen dataset first and put it in the ./data/trainging_data folder
...
#------------------------------------------------------
valid_keys =glob.glob('../../trainging_data/PDBscreen/PDBscreen_HQ_active_pocket/*')
...
cross_decoys= os.listdir('../../trainging_data/PDBscreen/PDBscreen_HQ_cross_decoy_pocket/')

cross_decoys_pros = set([v.split('/')[-1].split('_')[0] for v in cross_decoys])
print('cross_decoys pros :',len(cross_decoys_pros))
cross_decoys_dir = '../../trainging_data/PDBscreen/PDBscreen_HQ_cross_decoy_pocket/'
...
cross_decoys_dir_pose = '../../trainging_data/PDBscreen/PDBscreen_HQ_active_augment_2a_pose_pocket/'
poses = os.listdir('../../trainging_data/PDBscreen/PDBscreen_HQ_active_augment_2a_pose_pocket/')
...
valid_keys_screen = glob.glob('../../trainging_data/PDBscreen/PDBscreen_LQ_active_pocket/*')
# filtering
...
cross_decoys_screen= os.listdir('../../trainging_data/PDBscreen/PDBscreen_LQ_cross_decoy_pocket/')
...
cross_decoys_dir_screen = '../../trainging_data/PDBscreen/PDBscreen_LQ_cross_decoy_pocket/'
...
with open('../other_info/all_dulicatedpdb_ids.pkl','rb') as f:
