...
ref_list= [i.split('_')[0] for i in os.listdir('/home/caoduanhua/score_function/data/general_refineset/pdbbind_min_rmsd_pocket_without_h/')]
...
print(len(ref_list))
valid_keys = [i for i in valid_keys if i.split('/')[-1].split('_')[0] in ref_list]
# valid_keys +=glob.glob('/home/caoduanhua/score_function/data/general_refineset/refineset_active_pocket_without_h/*')
