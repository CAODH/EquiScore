...
#/home/jiangjiaxin/../../../
parser.add_argument("--save_dir", help="save directory of model parameter", type=str, default ='../train_result/graphnorm/dude/virtual_node/')
        ...
        for n_graph_layer in [4,3,2,1]:
                for n_FC_layer in [4,2]:
                    for virtual_aromatic_atom in [True]:
                            ...
                            args.virtual_aromatic_atom = virtual_aromatic_atom
                            if n_graph_layer*n_FC_layer > 6:
                                    args.batch_size = 8
